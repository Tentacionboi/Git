...
- Market-residual probability model. Conservative bounded adjustment from market probability using fundamental and movement signals done; report/UI integration pending.
- Poisson goals model.
